...
public partial class LandDispute_HQ_MapData_Print : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblVillage.Value = Village;
        lblform.Value = FromDate;
        lblTo.Value = ToDate;
        hdnAreaType.Value = AreaType;
        hdnBhumi_savedansheelta.Value = Bhumi_savedansheelta;
        hdnAction.Value = Action;
        hdnDataValue.Value = DataValue;
        

        if (!IsPostBack)
            LoadAllApplication(Village, FromDate, ToDate, AreaType, Bhumi_savedansheelta, Action, DataValue);
        // Response.Redirect("Displaydata.aspx?Village=" + Village + "&FromDate=" + FromDate + "&ToDate=" + ToDate);
    }
