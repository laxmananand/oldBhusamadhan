<%@ WebHandler Language="C#" Class="HandlerFilterGraph" %>
...
public class HandlerFilterGraph : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        try
        {
            ...
            conr = conr.Replace("is_FIR_registered=''Y''", "is_FIR_registered='Y'");
                 conr = conr.Replace("is_complaint_filed=''Y''", "is_complaint_filed='Y'");
                 conr = conr.Replace("is_Sanha_recorded=''Y''", "is_Sanha_recorded='Y'");
            string condition = "";
