...
$(document).ready(function () {
    ...
    $(".BhuDashboard").click(function (e) {
        ...
        var url = "Details.aspx?District=" + $("#ddDistrict").val() + "&Block=" + $("#ddBlock").val() + "&Panchayat=" + $("#ddPanchayat").val() + "&PoliceSation=" + $("#ddlPoliceSation").val() + "&Sensivity=" + $("#ddSensivity").val() + "&action=" + $("#ddlaction").val() + "&datefrom=" + $("#txtdatefrom").val() + "&DateTo=" + $("#txtDateTo").val() + "&datatype=" + datatype + "&datavivadtype=" + datavivadtype + "&textval=" + textval;
...
function getSenAction() {
    ...
    if ($("#ddPanchayat").val() != "0") {
        BindDataAccordingToFilter("Panchayat", $("#ddDistrict").val(), $("#ddBlock").val(), $("#ddPanchayat").val(), 0, $("#ddSensivity").val(), "usp_getPanchayatMapFilter", $("#ddlaction").val(), $("#ddlPoliceSation").val());
    }
        ...
        BindDataAccordingToFilter("Block", $("#ddDistrict").val(), $("#ddBlock").val(), $("#ddPanchayat").val(), 0, $("#ddSensivity").val(), "usp_getBlockMapFilter", $("#ddlaction").val(), $("#ddlPoliceSation").val());       
    }
    else if ($("#ddDistrict").val() == "0") {
...
function BindDataAccordingToFilter(Type, district_code, BlockCode, panchayatcode, VillageWard, savedansheelta, Procedure, Matter_Status, thanacode) {
    (async () => {
