<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DisplayData.aspx.cs" Inherits="LandDispute_HQ_DisplayData" EnableEventValidation="false" %>

<%@ Register Src="~/WebUserControlAction.ascx" TagPrefix="uc1" TagName="WebUserControlAction" %>
                                 ...
                                 <div class="">
                                    <table width="90%" style="text-align: left; top: 0; z-index: 1000;" align="center">
                                        ...
                                        <div class="panel-body">
                                                                             ...
                                                                             <div class="row">
                                                                                   <div class="col-md-12">
                                                                                               <asp:GridView runat="server" Width="100%" ID="gdVadiEvidence"  AutoGenerateColumns="false"
                                                                                                ...
                                                                                                ItemStyle-Width="5%">
                                                                                                <ItemTemplate>
                                                                                                <asp:ImageButton ID="Image1"  path='<%#Eval("FullfileName")%>' runat="server" ImageUrl="~/images/pdf.gif" Width="50px" Height="50px" class="getpdfdoc" Style="cursor: pointer" CommandArgument='<%# Container.DataItemIndex %>' CommandName="View"/>
                                                                                          ...
                                                                                          CssClass="table-responsive CSSTableGeneratorGrid" EmptyDataText="No Record Found!" >                                                                                 
                                                                                            <Columns>
                                                                                                ...
                                                                                                <asp:TemplateField HeaderText="साक्ष्य का दस्तावेज" ItemStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top" HeaderStyle-Wrap="false"
                                                                                                    ItemStyle-Width="5%">
                                                                                                    <ItemTemplate>                                                           
                                                                                                    <asp:ImageButton ID="Image1"  path='<%#Eval("FullfileName")%>' class="getpdfdoc" runat="server" ImageUrl="~/images/pdf.gif" Width="50px" Height="50px" Style="cursor: pointer" />                                 
                                                                                                    </ItemTemplate>
                                                                                                    <ItemStyle HorizontalAlign="Left" />
                                                                                                </asp:TemplateField>                                                                                                                                                                                                                                                                                                                  
                                                                                            </Columns>
                                           ...
                                           <%-- <uc1:WebUserControlAction runat="server" ID="WebUserControlAction" a_id='<%# Eval("a_id").ToString()%>' />
                                            <div class="view" id="View" runat="server"></div>--%>
