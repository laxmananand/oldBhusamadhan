...
public partial class LandDispute_HQ_DisplayData : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string AreaType = Request.QueryString["AreaType"].ToString();
        string Bhumi_savedansheelta = Request.QueryString["Bhumi_savedansheelta"].ToString();
        string Action = Request.QueryString["Action"].ToString();
       // string Id = Request.QueryString["Id"].ToString();
        string DataValue = Request.QueryString["DataValue"].ToString();
        if (AreaType == "Ward")
        {
            AreaType = "U";
        }
        ...
        ViewState["AreaType"] = AreaType;
        ViewState["Bhumi_savedansheelta"] = Bhumi_savedansheelta;
        ViewState["Action"] = Action;
        ViewState["DataValue"] = DataValue;
        Session["a_id"] = "";
        if (!IsPostBack)
            LoadAllApplication(Village, FromDate, ToDate, AreaType, Bhumi_savedansheelta, Action, DataValue);
    }
    ...
    /// </summary>  
    private void LoadAllApplication(string Village, string FromDate, string ToDate, string AreaType, string Bhumi_savedansheelta, string Action, string DataValue)
    {
        //SqlParameter _a_id2 = new SqlParameter("@a_id", Convert.ToInt32(a_id));
        SqlParameter _fn2 = new SqlParameter("@fn", "GetID");
        SqlParameter _Village = new SqlParameter("@Vill_ward", Village);
        SqlParameter _FromDate = new SqlParameter("@FromDate", FromDate);
        SqlParameter _ToDate = new SqlParameter("@ToDate", ToDate);
        SqlParameter _AreaType = new SqlParameter("@AreaType", AreaType);
        SqlParameter _Bhumi_savedansheelta = new SqlParameter("@Bhumi_savedansheelta", Bhumi_savedansheelta);
        SqlParameter _Action = new SqlParameter("@Action", Action);
        SqlParameter _con = new SqlParameter("@condition", DataValue);
        DataTable dt = clsData.GetDataTableWithProc("getEntryPage_print", new SqlParameter[] { _fn2, _Village, _FromDate, _ToDate, _AreaType, _Bhumi_savedansheelta, _Action, _con });
    ...
    private void WadikaVivaranDetails(string a_id, object sender, RepeaterItemEventArgs e)
    {
        ...
        if (dt_Wadi_ka_vivran.Rows.Count > 0)
        {
            ...
            {
                if (BindGetpdf(dt_Wadi_ka_vivran.Rows[0]["Prativadi_sakshya_File"].ToString()) != "0")
                {
                    div38.Visible = true;
                    ((ImageButton)e.Item.FindControl("lnkPrativadiDoc")).Attributes.Add("path", dt_Wadi_ka_vivran.Rows[0]["Prativadi_sakshya_File"].ToString());
                }
            }
    ...
    private void PoliceAdhikariVivranDetails(string a_id, object sender, RepeaterItemEventArgs e)
    {
        ...
        if (dt_PoliceAdhikariVivran.Rows.Count > 0)
        {
            ...
            HtmlGenericControl div20 = (HtmlGenericControl)e.Item.FindControl("div20");
            HtmlGenericControl div23 = (HtmlGenericControl)e.Item.FindControl("div23");
            HtmlGenericControl div26 = (HtmlGenericControl)e.Item.FindControl("div26");
            if (dt_PoliceAdhikariVivran.Rows[0]["pulis_padadhikar_Patr_file"].ToString() != "")
            {
               
                if(BindGetpdf(dt_PoliceAdhikariVivran.Rows[0]["pulis_padadhikar_Patr_file"].ToString()) !="0")
                {
                    div20.Visible = true;
                    ((ImageButton)e.Item.FindControl("lnkpulis_padadhikari_Patr_file")).Attributes.Add("path", dt_PoliceAdhikariVivran.Rows[0]["pulis_padadhikar_Patr_file"].ToString());
                }
            }
            if (dt_PoliceAdhikariVivran.Rows[0]["HalkaKarmchari_Patr_file"].ToString() != "")
            {
                if (BindGetpdf(dt_PoliceAdhikariVivran.Rows[0]["HalkaKarmchari_Patr_file"].ToString()) != "0")
                {
                    div23.Visible = true;
                    ((ImageButton)e.Item.FindControl("lnkfile_halkakarmchari_praptr")).Attributes.Add("path", dt_PoliceAdhikariVivran.Rows[0]["HalkaKarmchari_Patr_file"].ToString());
                }
            }
            if (dt_PoliceAdhikariVivran.Rows[0]["vivaadit_bhukhand_Mapi_File"].ToString() != "")
            {
                if (BindGetpdf(dt_PoliceAdhikariVivran.Rows[0]["vivaadit_bhukhand_Mapi_File"].ToString()) != "0")
                {
                    div26.Visible = true;
                    ((ImageButton)e.Item.FindControl("lnkfile_bhukand_prativedan")).Attributes.Add("path", dt_PoliceAdhikariVivran.Rows[0]["vivaadit_bhukhand_Mapi_File"].ToString());
                }
            }
        }
    }
    ...
    {
        SqlParameter _a_id2 = new SqlParameter("@a_id", Convert.ToInt32(a_id));
        SqlParameter _fn2 = new SqlParameter("@fn", "getActionDetailsEntryAllRepeterOne");
        DataTable dt_nyayalay_vivran = clsData.GetDataTableWithProc("getEntryPage_print", new SqlParameter[] { _a_id2, _fn2 });
        ViewState["gridTable"] = dt_nyayalay_vivran;
        ...
        if (dt_nyayalay_vivran.Rows.Count > 0)
        {
            ...
            HtmlGenericControl div18 = (HtmlGenericControl)e.Item.FindControl("div18");
            HtmlGenericControl div19 = (HtmlGenericControl)e.Item.FindControl("div19");
            if (dt_nyayalay_vivran.Rows[0]["Joint_report_SHO_Circle_Officer_file"].ToString()!="")
            {
                if (BindGetpdf(dt_nyayalay_vivran.Rows[0]["Joint_report_SHO_Circle_Officer_file"].ToString()) != "0")
                {
                    div1.Visible = true;
                    ((ImageButton)e.Item.FindControl("lnkLandDoc")).Attributes.Add("path", dt_nyayalay_vivran.Rows[0]["Joint_report_SHO_Circle_Officer_file"].ToString());
                }
            }
            if (dt_nyayalay_vivran.Rows[0]["CircleOfficer_letterOfIntent"].ToString() != "")
            {
                if (BindGetpdf(dt_nyayalay_vivran.Rows[0]["CircleOfficer_letterOfIntent"].ToString()) != "0")
                {
                    div18.Visible = true;
                    ((ImageButton)e.Item.FindControl("lnkCircleOfficer_letterOfIntent")).Attributes.Add("path", dt_nyayalay_vivran.Rows[0]["CircleOfficer_letterOfIntent"].ToString());
                }
            }
            if (dt_nyayalay_vivran.Rows[0]["PoliceOfficer_letterOfIntent"].ToString() != "")
            {
                if (BindGetpdf(dt_nyayalay_vivran.Rows[0]["PoliceOfficer_letterOfIntent"].ToString()) != "0")
                {
                    div19.Visible = true;
                    ((ImageButton)e.Item.FindControl("lnkPoliceOfficer_letterOfIntent")).Attributes.Add("path", dt_nyayalay_vivran.Rows[0]["PoliceOfficer_letterOfIntent"].ToString());
                }
            }
        }
    }

    private void MultiActionDetailsEntryDetails_ka_vivran(string a_id, object sender, RepeaterItemEventArgs e)
    {
        SqlParameter _a_id2 = new SqlParameter("@a_id", Convert.ToInt32(a_id));
        SqlParameter _fn2 = new SqlParameter("@fn", "getActionDetailsEntryAll");
        DataTable dt = clsData.GetDataTableWithProc("getEntryPage_print", new SqlParameter[] { _a_id2, _fn2 });
       
        GridView GVAnchalaDhakari = (GridView)e.Item.FindControl("GVAnchalaDhakari");
    ...
    private void Remarks(string a_id, object sender, RepeaterItemEventArgs e)
    {
        SqlParameter _a_id2 = new SqlParameter("@a_id", Convert.ToInt32(a_id));
        SqlParameter _fn2 = new SqlParameter("@fn", "getRemarks");
        DataTable dt = clsData.GetDataTableWithProc("getEntryPage_print", new SqlParameter[] { _a_id2, _fn2 });

        GridView grdRemarks = (GridView)e.Item.FindControl("grdRemarks");
        ViewState["gridTable"] = dt;
        grdRemarks.DataSource = dt;
        grdRemarks.DataBind();
    }
    protected void parentRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
        {
           ...
           // MultiActionDetailsEntryDetails_ka_vivran(lbla_id.Value, sender, e);

            //HtmlGenericControl sample = e.Item.FindControl("View") as HtmlGenericControl;

            //Control _dummyUserControl = (Control)Page.LoadControl("../../WebUserControlAction.ascx");

            //HtmlGenericControl pnlDynamicControl = (HtmlGenericControl)e.Item.FindControl("pnlDynamicControl");
            //// Add the control to the panel  
            // sample.Controls.Add(_dummyUserControl);

            //DataTable dt = new DataTable();
            //dt.Columns.Add("a_id", typeof(string));
            //DataRow workRow = dt.NewRow();
            //workRow["a_id"] = lbla_id.Value;
            //dt.Rows.Add(workRow);

            //Repeater childRepeater = (Repeater)e.Item.FindControl("childRepeater");
            //childRepeater.DataSource = dt;
            //childRepeater.DataBind();
            binAction(lbla_id.Value, sender, e);
            Remarks(lbla_id.Value, sender, e);
        }
    }


    private void binAction(string a_id, object sender, RepeaterItemEventArgs e)
    {
        SqlParameter _a_id2 = new SqlParameter("@a_id", Convert.ToInt32(a_id));
        SqlParameter _fn2 = new SqlParameter("@fn", "getActionDetailsEntryAllRepeter");
        DataTable dt = clsData.GetDataTableWithProc("getEntryPage_print", new SqlParameter[] { _a_id2, _fn2 });
    ...
    {
        Response.Redirect("print.aspx?Village=" + ViewState["Village"] + "&AreaType=" + ViewState["AreaType"] + "&FromDate=" + ViewState["FromDate"] + "&ToDate=" + ViewState["ToDate"] + "&Bhumi_savedansheelta=" + ViewState["Bhumi_savedansheelta"] + "&Action=" + ViewState["Action"] + "&Id=" + ViewState["Id"] + "&DataValue=" + ViewState["DataValue"]);
    }
