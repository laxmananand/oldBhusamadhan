<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Print.aspx.cs" Inherits="LandDispute_HQ_MapData_Print" EnableEventValidation="false" %>
...
<body>
            ...
            <tr>
                ...
                <td style="width:70%">
                    ...
                    <div  id="printdiv" runat="server" >
                        ...
                        <asp:HiddenField ID="hdnAreaType" runat="server" value=''></asp:HiddenField>
                        <asp:HiddenField ID="hdnBhumi_savedansheelta" runat="server" value=''></asp:HiddenField>
                        <asp:HiddenField ID="hdnAction" runat="server" value=''></asp:HiddenField>
                        <asp:HiddenField ID="hdnDataValue" runat="server" value=''></asp:HiddenField>
  ...
  <%--अंचलाधिकरी एवम्‌ थाना अध्यक्ष द्वारा भूमि विवाद क़े निराकरण हेतु कृत करवाई की विवरणी--%>
                ...
                <td>
                    <asp:Panel ID="Panel13" GroupingText="अंचलाधिकारी एवं थानाध्यक्ष द्वारा भूमि विवाद के निराकरण हेतु कृत कारवाई का विवरण" runat="server" Font-Bold="False" Font-Size="Small">
                        <asp:Repeater ID="childRepeater" runat="server" OnItemDataBound="childRepeater_ItemDataBound">  
                                                                        ...
                                                                        <ItemTemplate> 
                                                                        <asp:HiddenField ID="lbla_idc" runat="server" value='<%#Eval("id") %>'></asp:HiddenField>
                        <table width="100%">
                            <tr>
                                <td valign="top" style="width: 25%;font-weight:bold">
        ...
        <%--    <tr>
                <td>
                    <asp:Panel ID="Panel10" GroupingText="अंचलाधिकारी एवं थानाध्यक्ष द्वारा भूमि विवाद के निराकरण हेतु कृत कारवाई का विवरण" runat="server" Font-Bold="False" Font-Size="Small">
                        <asp:GridView ID="GVAnchalaDhakari" runat="server"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="थानाध्यक्ष एवं अंचलाधिकारी का संयुक्त प्रतिवेदन<br/>अंचलाधिकारी का मंतव्य पत्र<br/>थानाध्यक्ष का मंतव्य पत्र" ItemStyle-HorizontalAlign="Left"
                                        ItemStyle-Width="15%">
                                        <ItemTemplate>   
                                             <asp:ImageButton ID="ImageButton1" Visible='<%# CheckNull(Eval("Joint_report_SHO_Circle_Officer_file"))%>'  path='<%#Eval("Joint_report_SHO_Circle_Officer_file")%>' runat="server" class="getpdfdoc" ImageUrl="~/images/pdf.gif" Width="50px" Height="50px" Style="cursor: pointer" /><br />
                                             <asp:ImageButton ID="ImageButton2" Visible='<%# CheckNull(Eval("CircleOfficer_letterOfIntent"))%>'  path='<%#Eval("CircleOfficer_letterOfIntent")%>' runat="server" class="getpdfdoc" ImageUrl="~/images/pdf.gif" Width="50px" Height="50px" Style="cursor: pointer" /><br />
                                            <asp:ImageButton ID="Image1" Visible='<%# CheckNull(Eval("PoliceOfficer_letterOfIntent"))%>'  path='<%#Eval("PoliceOfficer_letterOfIntent")%>' runat="server" class="getpdfdoc" ImageUrl="~/images/pdf.gif" Width="50px" Height="50px" Style="cursor: pointer" />
                                 ...
                                 <tr>
                <td>
                    <asp:Panel ID="Panel12" GroupingText="मंतव्य की विवरणी" runat="server" Font-Bold="False" Font-Size="Small">
                        <asp:GridView ID="grdRemarks" runat="server"
                                DataKeyNames="a_id" AutoGenerateColumns="false" EnableTheming="false" Width="100%"
                                CssClass="w3-table w3-striped" AllowPaging="false"  Style="width: 100%;"                            
                                ShowHeaderWhenEmpty="True"  EmptyDataRowStyle-HorizontalAlign="Left" EmptyDataRowStyle-VerticalAlign="Middle"
                                 EmptyDataText="No Record Found" Visible="true">
    ...
    <script type="text/javascript">
        ...
        setTimeout(() => {
            PrintDiv();
            window.open("DisplayData.aspx?Village=" + document.getElementById('lblVillage').value + "&FromDate=" + document.getElementById('lblform').value + "&ToDate=" + document.getElementById('lblTo').value + "&AreaType=" + document.getElementById('hdnAreaType').value + "&Bhumi_savedansheelta=" + document.getElementById('hdnBhumi_savedansheelta').value + "&Action=" + document.getElementById('hdnAction').value + "&DataValue=" + document.getElementById('hdnDataValue').value);
            window.stop();
