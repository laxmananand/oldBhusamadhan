<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="VerifyByCo.aspx.cs" Inherits="Police_Station_add" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container-fluid">
                 ...
                 <div class="row">
                                            ...
                                            Height="50px" Style="cursor: pointer" />
                                                                    ...
                                                                    <div class="col-md-3" style="font-weight: bold;font-size:14px">
                                                                      ...
                                                                      <div class="col-md-3">
                                                                            <asp:ImageButton ID="lnkPrativadiDoc" path="display"  class="getpdfdoc"  runat="server" ImageUrl="/images/pdf.gif" Width="50px"
                                            Height="50px" Style="cursor: pointer"  />
                                                                      </div> 
                                                                </div>
            </div>
        ...
        <div class="card mb-2">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="row">                                                                             
                                                                                 <div class="col-md-4" id="divprativadi_ka_suchit_Label" runat="server" style="font-weight: bold;font-size:14px">
                                                                                       प्रतिवादी को सूचित किया गया है या नहीं ?
                                                                                 </div>
                                                                                 <div class="col-md-2" id="divprativadi_ka_suchit" runat="server" style="font-size:12px">
                                                                                ...
                                                                                <div class="col-md-3" id="divprativadi_ka_madham_Label" runat="server" style="font-weight: bold;font-size:14px">
                                                                                 ...
                                                                                 <div class="col-md-4" id="divprativadi_ka_Suchna_Label" runat="server" style="font-weight: bold;font-size:14px">
                                                                                       प्रतिवादी को सूचना तामिला प्राप्त है या नहीं ?
                                                                                 </div>
                                                                                 <div class="col-md-2" id="divprativadi_ka_Suchna" runat="server" style="font-size:12px">
        ...
        <div class="card mb-2">
            ...
            <div class="card-body">
               <div class="row">
                 ...
                 <div class="row" style="padding-top: 7px" id="step5" runat="server" visible="false">
                    <div class="col-md-1" style="font-weight: bold;font-size:14px">
                        सत्यापित<img src="images/red_star_PNG44.png" width="13px" />
                    </div>
                    <div class="col-md-2">
                        <asp:DropDownList runat="server" ID="ddlVerifyStatus5" CssClass="form-control selectEvent" data-id="5" >
                    ...
                    <div class="col-md-1" style="font-weight: bold;font-size:14px">
                        मंतव्य <span id="descriptionspan5" class="hidden"><img src="images/red_star_PNG44.png" width="13px" /></span>
                    </div>
                    <div class="col-md-7">
                        <asp:TextBox runat="server" MaxLength="500" TextMode="MultiLine" Height="60px" ID="txtDescription5"
                     ...
                     <div class="col-md-1" style="font-weight: bold;font-size:14px">
                        <asp:Button ID="btnSave5" runat="server" Text="Verify" CssClass="btn btn-primary clickEvent" data-id="5"  width="100%"  OnClick="btnSave5_Click"/>
                    </div>
                </div>
            </div>
        </div>
        <div class="card mb-2">
            <div class="card-header bg-primary text-white">
             ...
             <div class="card-body">
                 ...
                 <div class="row" style="padding-top: 7px" id="step6" runat="server" visible="false">
                    <div class="col-md-1" style="font-weight: bold;font-size:14px">
                        सत्यापित<img src="images/red_star_PNG44.png" width="13px" />
                    </div>
                    <div class="col-md-2">
                        <asp:DropDownList runat="server" ID="ddlVerifyStatus6" CssClass="form-control selectEvent" data-id="6"  >
                            <asp:ListItem Value="0">--चुने--</asp:ListItem>
                            <asp:ListItem Value="Y">हां</asp:ListItem>
                            <asp:ListItem Value="N">नहीं</asp:ListItem>
                        </asp:DropDownList>
                    ...
                    <div class="col-md-1" style="font-weight: bold;font-size:14px">
                        मंतव्य <span id="descriptionspan6"><img src="images/red_star_PNG44.png" width="13px" /></span>
                    </div>
                    <div class="col-md-7">
                        <asp:TextBox runat="server" MaxLength="500" TextMode="MultiLine" Height="60px" ID="txtDescription6"
                            CssClass="form-control"></asp:TextBox>
                        <div style="text-align:right; color: #FF3300; font-weight: bold"> 
                                        अधिकतम 500 वर्ण
                                    </div>
                     ...
                     <div class="col-md-1" style="font-weight: bold;font-size:14px">
                        <asp:Button ID="btnSave6" runat="server" Text="Verify" CssClass="btn btn-primary clickEvent" data-id="6"  width="100%"  OnClick="btnSave6_Click"/>
                    </div>
                </div>
                 </div>
        ...
        <div class="card mb-2">
            ...
            <div class="card-body">
                <div class="row">
                                                                                   <div class="col-md-12">
                                                                                      <asp:GridView runat="server" Width="100%" ID="gdPrativadiEvidence"  AutoGenerateColumns="false"
                                                                                          CssClass="table-responsive CSSTableGeneratorGrid" EmptyDataText="No Record Found!" OnRowDataBound="gdPrativadiEvidence_RowDataBound" >                                                                                 
                                                                                            <Columns>
                                                                                                <asp:TemplateField HeaderText="Sl. No.">
                                                                                                                        <ItemTemplate>
                                                                                                                            <%# Container.DataItemIndex + 1 %>
                ...
                <div class="row" style="padding-top: 7px" id="step7" runat="server" visible="false">
                    <div class="col-md-1" style="font-weight: bold;font-size:14px">
                        सत्यापित<img src="images/red_star_PNG44.png" width="13px" />
                    </div>
                    <div class="col-md-2">
                        <asp:DropDownList runat="server" ID="ddlVerifyStatus7" CssClass="form-control selectEvent" data-id="7"  >
                            <asp:ListItem Value="0">--चुने--</asp:ListItem>
                            <asp:ListItem Value="Y">हां</asp:ListItem>
                            <asp:ListItem Value="N">नहीं</asp:ListItem>
                        </asp:DropDownList>
                    ...
                    <div class="col-md-1" style="font-weight: bold;font-size:14px">
                        मंतव्य <span id="descriptionspan7"><img src="images/red_star_PNG44.png" width="13px" /></span>
                    </div>
                    <div class="col-md-7">
                        <asp:TextBox runat="server" MaxLength="500" TextMode="MultiLine" Height="60px" ID="txtDescription7"
                            CssClass="form-control"></asp:TextBox>
                        <div style="text-align:right; color: #FF3300; font-weight: bold"> 
                                        अधिकतम 500 वर्ण
                                    </div>
                     ...
                     <div class="col-md-1" style="font-weight: bold;font-size:14px">
                        <asp:Button ID="btnSave7" runat="server" Text="Verify" CssClass="btn btn-primary clickEvent" data-id="7"  width="100%" OnClick="btnSave7_Click" />
                    </div>
                </div>
        ...
        <div class="card mb-2">
            ...
            <div class="card-body">
                <div class="row">                                                                             
                                                                                             <div class="col-md-4" id="div2" runat="server" style="font-weight: bold;font-size:14px">
                                                                                                   पुलिस पदाधिकारी द्वारा समर्पित जाँच प्रतिवेदन की संक्षिप्त विवरणी 
                                                                                             </div>
                                                                                             <div class="col-md-8" id="divPoliceAdhikari" runat="server" style="font-size:12px">
                                                                                                     <asp:Label ID="lblPoliceAdhikari" runat="server"></asp:Label>
                                                                                             </div>                                                                                                                                                                                                                                            
                                                                                   </div>  
                                                                                        
                                                                                   <div class="row" id="divHalkaKarmchari" runat="server">                                                                             
                                                                                             <div class="col-md-4" id="div4" runat="server" style="font-weight: bold;font-size:14px">
                                                                                                   हल्का कर्मचारी / राजस्व अधिकारी द्वारा समर्पित जाँच प्रतिवेदन की संक्षिप्त विवरणी
                                                                                             </div>
                                                                                             <div class="col-md-8" id="divHalkaKarmchariValue" runat="server" style="font-size:12px">
                                                                                                     <asp:Label ID="lblHalkaKarmchariValue" runat="server"></asp:Label>
                                                                                             </div>                                                                                                                                                                                                                                            
                                                                                   </div> 
                                                                                    <div class="row" id="div1" runat="server">                                                                             
                                                                                             <div class="col-md-6"  style="font-weight: bold;font-size:14px">
                                                                                                 <div class="row">
                                                                                                     <div class="col-md-9">पुलिस पदाधिकारी द्वारा समर्पित जाँच प्रतिवेदन का दस्तावेज</div>
                                                                                                     <div class="col-md-3">
                                                                                                         <asp:ImageButton runat="server" ID="lnkpulis_padadhikari_Patr_file" path="display" class="getpdfdoc"  ImageUrl="/images/pdf.gif" Width="50px" Height="50px" Style="cursor: pointer"  />
                                                                                                     </div>
                                                                                                 </div>
                                                                                             ...
                                                                                             <div class="col-md-6" style="font-weight: bold;font-size:14px">
                                                                                                 <div class="row">
                                                                                                     <div class="col-md-9"> हल्का कर्मचारी / राजस्व अधिकारी द्वारा समर्पित जाँच प्रतिवेदन की संक्षिप्त विवरणी  </div>
                                                                                                     <div class="col-md-3">
                                                                                                         <asp:ImageButton runat="server" ID="lnkfile_halkakarmchari_praptr" path="display" class="getpdfdoc"  ImageUrl="/images/pdf.gif" Width="50px" Height="50px" Style="cursor: pointer"  />
                                                                                                     </div>
                                                                                                 </div>
                                                                                   ...
                                                                                   <div class="row" id="divVivaditBhukand" runat="server">                                                                             
                                                                                             <div class="col-md-4" id="div6" runat="server" style="font-weight: bold;font-size:14px">
                                                                                                  विवादित भू-खंड की मापी 
                                                                                             </div>
                                                                                             <div class="col-md-8" id="divVivaditBhukandValue" runat="server" style="font-size:12px">
                                                                                   ...
                                                                                   <div class="row" id="divVivaditBhukandKaMapi" runat="server">                                                                             
                                                                                       ...
                                                                                       <div class="col-md-3" id="div7" runat="server" style="font-weight: bold;font-size:14px">
                                                                                             ...
                                                                                             <div class="col-md-9" id="div9" runat="server" style="font-size:12px">
                                                                                                 <asp:ImageButton runat="server" ID="lnkfile_bhukand_prativedan" path="display" class="getpdfdoc"  ImageUrl="/images/pdf.gif" Width="50px" Height="50px" Style="cursor: pointer"  />
                                                                                             </div> 
                                                                                   </div>    
                                                                                     <br/>
        ...
        <div class="card mb-2">
            ...
            <div class="card-body">
                <div class="row">                                                                             
                 ...
                 <div class="row" style="padding-top: 7px" id="step10" runat="server" visible="false">
                    <div class="col-md-1" style="font-weight: bold;font-size:14px">
                        सत्यापित<img src="images/red_star_PNG44.png" width="13px" />
                    </div>
                    <div class="col-md-2">
                        <asp:DropDownList runat="server" ID="ddlVerifyStatus10" CssClass="form-control selectEvent" data-id="10"  >
                            <asp:ListItem Value="0">--चुने--</asp:ListItem>
                            <asp:ListItem Value="Y">हां</asp:ListItem>
                            <asp:ListItem Value="N">नहीं</asp:ListItem>
                        </asp:DropDownList>
                    ...
                    <div class="col-md-1" style="font-weight: bold;font-size:14px">
                        मंतव्य <span id="descriptionspan10"><img src="images/red_star_PNG44.png" width="13px" /></span>
                    </div>
                    <div class="col-md-7">
                        <asp:TextBox runat="server" MaxLength="500" TextMode="MultiLine" Height="60px" ID="txtDescription10"
                            CssClass="form-control"></asp:TextBox>
                        <div style="text-align:right; color: #FF3300; font-weight: bold"> 
                                        अधिकतम 500 वर्ण
                                    </div>
                     ...
                     <div class="col-md-1" style="font-weight: bold;font-size:14px">
                        <asp:Button ID="btnSave10" runat="server" Text="Verify" CssClass="btn btn-primary clickEvent" data-id="10"  width="100%" OnClick="btnSave10_Click" />
                    </div>
                </div>
                 </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <asp:GridView ID="GVAnchalaDhakari" OnRowCommand="GVBhumiVivran_RowCommand" runat="server"
                                ...
                                OnPageIndexChanging="GVBhumiVivran_PageIndexChanging" OnRowDataBound="GridView1_RowDataBound"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="थानाध्यक्ष एवं अंचलाधिकारी का संयुक्त प्रतिवेदन" ItemStyle-HorizontalAlign="Left"
                                        ItemStyle-Width="15%">
                                        <ItemTemplate>                                            
                                            <asp:ImageButton ID="Image1" Visible='<%# CheckImage(Eval("Joint_report_SHO_Circle_Officer_file"))%>'  path='<%#Eval("Joint_report_SHO_Circle_Officer_file")%>' runat="server" ImageUrl="~/images/pdf.gif" Width="50px" Height="50px" Style="cursor: pointer" />
                                     ...
                                     <asp:TemplateField HeaderText="मंतव्य विवरण द्वारा" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="20%">
                                       ...
                                       <asp:TemplateField HeaderText="दस्तावेज देखें" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="30%">
                                        <ItemTemplate>
                                            ...
                                            <asp:ImageButton ID="Image1" Visible='<%# CheckImage(Eval("Remarks_file"))%>' path='<%#Eval("Remarks_file")%>' runat="server" ImageUrl="~/images/pdf.gif" Width="50px" Height="50px" Style="cursor: pointer" CommandArgument='<%# Container.DataItemIndex %>' CommandName="View"/>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" />
                                    </asp:TemplateField>
        ...
        <div class="card mb-2">
               ...
               <div class="row">
                   ...
                   <div class="col-md-1" style="font-weight: bold;font-size:14px">
                        <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btn btn-danger"  width="100%"  OnClick="btnSave_Click"/>
                    </div>
                   </div>
                   </div>
            </div>
    ...
    <script src="JS/CoVerify.js"></script>
