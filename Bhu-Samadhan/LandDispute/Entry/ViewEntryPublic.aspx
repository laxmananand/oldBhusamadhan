<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewEntryPublic.aspx.cs" Inherits="LandDispute_Dashboard_View"
    ...
    <form id="form1" runat="server">  
       ...
       <%-- <asp:UpdatePanel ID="udpOrderDescription" runat="server">  
        ...
        <table>
            ...
            <tr>
                <td>
                    <asp:Panel ID="Panel2" GroupingText="भूमि विवाद का प्रकार" runat="server" Font-Bold="False" Font-Size="Small">
                        <table width="100%">
                            <tr>
     ...
     <td>
         <asp:Panel ID="Panel3" GroupingText="प्रतिवादी का विवरण" runat="server" Font-Bold="False" Font-Size="Small">
            ...
            <tr>
                <td>
                    <asp:Panel ID="Panel5" GroupingText="विवादित भूमि का विवरण" runat="server" Font-Bold="False" Font-Size="Small">
