...
public partial class LandDispute_Entry_InformationEntry_co : System.Web.UI.Page
{
    DataSet ds;
    ...
    private void LoadAllApplication(string A_ID)
    {
        ...
        DataTable dt = clsData.GetDataTableWithProc("getEntryPage_print_Information_co", new SqlParameter[] { _fn2, _a_id });
    ...
    private void Wadi_ka_vivran(string a_id, object sender, RepeaterItemEventArgs e)
    {
        ...
        DataTable dt_wadi = clsData.GetDataTableWithProc("getEntryPage_print_Information_co", new SqlParameter[] { _a_id2, _fn2 });
    ...
    private void WadikaVivaranDetails(string a_id, object sender, RepeaterItemEventArgs e)
    {
        ...
        DataTable dt_Wadi_ka_vivran = clsData.GetDataTableWithProc("getEntryPage_print_Information_co", new SqlParameter[] { _a_id, _fn2 });
    ...
    private void PratiWadi_ka_vivran(string a_id, object sender, RepeaterItemEventArgs e)
    {
        ...
        DataTable dt_Pratiwadi = clsData.GetDataTableWithProc("getEntryPage_print_Information_co", new SqlParameter[] { _a_id2, _fn2 });
    ...
    private void bhumikhata_Shekher_Ka_Vivaran(string a_id, object sender, RepeaterItemEventArgs e)
    {
        ...
        DataTable dt_bhumikhata_Shekher_Ka_Vivaran = clsData.GetDataTableWithProc("getEntryPage_print_Information_co", new SqlParameter[] { _a_id2, _fn2 });
    ...
    private void vadiEvidanceKa_Vivaran(string a_id, object sender, RepeaterItemEventArgs e)
    {
        ...
        DataTable dt_vadiEvidance = clsData.GetDataTableWithProc("getEntryPage_print_Information_co", new SqlParameter[] { _a_id2, _fn2 });
    ...
    private void PrativadiEvidanceKa_Vivaran(string a_id, object sender, RepeaterItemEventArgs e)
    {
        ...
        DataTable dt_PrativadiEvidance = clsData.GetDataTableWithProc("getEntryPage_print_Information_co", new SqlParameter[] { _a_id2, _fn2 });
    ...
    private void LandDisputeDetails_ka_vivran(string a_id, object sender, RepeaterItemEventArgs e)
    {
        ...
        DataTable dt_bhumivivad = clsData.GetDataTableWithProc("getEntryPage_print_Information_co", new SqlParameter[] { _a_id2, _fn2 });
    ...
    private void CourtDisputeDetails_ka_vivran(string a_id, object sender, RepeaterItemEventArgs e)
    {
        ...
        DataTable dt_nyayalay_vivran = clsData.GetDataTableWithProc("getEntryPage_print_Information_co", new SqlParameter[] { _a_id2, _fn2 });
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("ViewEntry.aspx?A_ID=" + ViewState["A_ID"].ToString(), false);
    }
    ...
    protected void gvDocs_RowCommandd(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "ViewDoc")
        {
            string filePath = e.CommandArgument.ToString();
