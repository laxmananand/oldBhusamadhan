<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master"  CodeFile="ViewPublic.aspx.cs" Inherits="LandDispute_Entry_Unfinalize" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="container-fluid">
      ...
      <ItemTemplate>
          <asp:LinkButton ID="lnkApplicationNo" runat="server" CommandArgument='<%#Eval("a_id")%>' Font-Underline="false" ForeColor="Blue" OnClick="lnkView_Click" OnClientClick="openwindow(this);" Text='View Application'></asp:LinkButton><br />
          <asp:LinkButton ID="lnkAddMeeting" runat="server" CommandArgument='<%#Eval("a_id")%>' Font-Underline="false" ForeColor="Blue" OnClick="lnkAddMeeting_Click" OnClientClick="openwindow(this);" Text='Add Metting' Visible='<%# Convert.ToBoolean(Eval("Meeting")) %>'></asp:LinkButton>
          <asp:LinkButton ID="lnkStaus" runat="server" CommandArgument='<%#Eval("a_id")%>' Font-Underline="false" ForeColor="Blue" OnClick="lnkStaus_Click" OnClientClick="openwindow(this);" Text='Add Status' Visible='<%# Convert.ToBoolean(Eval("Status")) %>'></asp:LinkButton>
