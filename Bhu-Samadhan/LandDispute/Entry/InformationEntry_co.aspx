<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InformationEntry_co.aspx.cs" Inherits="LandDispute_Entry_InformationEntry_co" %>
...
<%--<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js"/></script>--%>
 ...
 function getpdfdocument(urlpdf) {
     ...
     $.ajax({
         type: "POST",
         url: "InformationEntry_co.aspx/Getpdf",
         data: "{'url':'" + urlpdf + "'}",
                                                    ...
                                                    <br/> 
                                                     ...
                                                     <div class="row">
                                                          ...
                                                          <div class="panel-body">
                                                            ...
                                                            <%--              <asp:ImageButton ID="ImageButton1" path="display"  class="getpdfdoc"  runat="server" ImageUrl="~/images/pdf.gif" Width="50px" Height="50px" Style="cursor: pointer"  />--%>
                                                                ...
                                                                <div class="panel panel-default">
                                                                      ...
                                                                      <div class="panel-body">
                                                                            <br/> 
                                                                             <div class="row">
                                                                                   <div class="col-md-12">
                                                                                      <asp:GridView runat="server" Width="100%" ID="gdPrativadiEvidence"  AutoGenerateColumns="false" OnRowCommand="gvDocs_RowCommandd"
                                                                                          CssClass="table-responsive CSSTableGeneratorGrid" EmptyDataText="No Record Found!">                                                                                 
                                                                                            <Columns>
                                                                                                <asp:TemplateField HeaderText="Sl. No.">
                                                                                                                        <ItemTemplate>
