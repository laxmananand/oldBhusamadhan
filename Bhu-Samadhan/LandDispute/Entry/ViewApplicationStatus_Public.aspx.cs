...
public partial class LandDispute_Entry_ViewApplicationStatus_Public : System.Web.UI.Page
{
    ...
    private void GV_GetThanaDeatilsPageWise(int pageIndex)
    {
        ...
        try
        {
            ...
            dt = clsData.GetDataTableWithProc("usp_GetSaveDataUnFinalizePublic_st", p);
            int totalRecord = 0;
            if (p[2].Value != null)
            {
    ...
    protected void lnkView_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string UrlRedirect = enc.Encrypt(linkbtn.CommandArgument); ;// enc.Encrypt(linkbtn.CommandArgument);
            Response.Redirect("PublicStatus_AllDetails.aspx?RegId=" + UrlRedirect);
