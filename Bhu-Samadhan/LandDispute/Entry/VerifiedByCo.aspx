<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="VerifiedByCo.aspx.cs" Inherits="LandDispute_Entry_SearchAppForMetting" %>
...
<div class="col-md-3">
           ...
           <asp:GridView runat="server" Width="100%" ID="GridView1" AutoGenerateColumns="false" CssClass="table-responsive CSSTableGeneratorGrid fontsize" OnRowDataBound="GridView1_RowDataBound"
               DataKeyNames="a_id" EnableTheming="false"  ShowFooter="true" EmptyDataText="No Record Found" Visible="true"
               >
                 <Columns>
                            ...
                            <asp:TemplateField HeaderText="Application No." ItemStyle-VerticalAlign="Top" ItemStyle-HorizontalAlign="Left"
                                ...
                                <ItemTemplate>
                                    ...
                                    <%--<asp:LinkButton ID="lnkApplicationNo" OnClientClick="openwindow(this);" runat="server" ForeColor="Blue"
                                            Text='Add Remarks' CommandArgument='<%#Eval("a_id")%>' Font-Underline="false" OnClick="lnkView_Click"></asp:LinkButton>--%>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:TemplateField>
                       ...
                       <asp:TemplateField HeaderText="अंचल अधिकारी द्वारा सत्यापित" ItemStyle-HorizontalAlign="Left" HeaderStyle-Wrap="false" 
                               ItemStyle-VerticalAlign="Top" ItemStyle-Width="20%"  HeaderStyle-Width="20%">
                                <ItemTemplate>
                                    <b><asp:Label runat="server"  Text="भूमि का खाता-खेसरा" Visible='<%# CheckNull(Eval("BhumiKaKhataKhesraStatus"))%>' ></asp:Label></b><br /> Status : <%#Eval("BhumiKaKhataKhesraStatus")%><hr />
                                   
                                    <b><asp:Label runat="server"  Text="वादी द्वारा प्रस्तुत साक्ष्य" Visible='<%# CheckNull(Eval("VadiEdStatus"))%>' ></asp:Label></b></br>Status :  <%#Eval("VadiEdStatus")%><hr />
                                   
                                     <b><asp:Label runat="server"  Text="प्रतिवादी द्वारा प्रस्तुत साक्ष्य" Visible='<%# CheckNull(Eval("PrativadiEDStatus"))%>' ></asp:Label></b></br> Status : <%#Eval("PrativadiEDStatus")%><hr />
                                    
                                     <b><asp:Label runat="server"  Text="न्यायालय में प्रक्रियाधीन" Visible='<%# CheckNull(Eval("CourtStatus"))%>' ></asp:Label></b></br>Status :  <%#Eval("CourtStatus")%>
