<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPagePublic.master" AutoEventWireup="true" CodeFile="ViewApplicationStatus_Public.aspx.cs" Inherits="LandDispute_Entry_ViewApplicationStatus_Public" %>
                         ...
                         <asp:TemplateField HeaderText="जिला <hr style='margin-bottom: 0px; margin-top: 0px;' /> अनुमंडल <hr style='margin-bottom: 0px; margin-top: 0px;' /> अंचल" ItemStyle-HorizontalAlign="Left"
                            ...
                            <ItemStyle HorizontalAlign="Left" />
                                     ...
                                     <asp:BoundField DataField="vivadtype" HeaderText="भूमि विवाद का प्रकार" ItemStyle-Width="18%" />  
                                                                                         <asp:TemplateField HeaderText="बैठक<br> की तिथि" 
                   ItemStyle-VerticalAlign="Top" 
                   ItemStyle-HorizontalAlign="Left" 
                   HeaderStyle-Wrap="false" 
                   ItemStyle-Width="5%">
    <ItemTemplate>
        <%# Eval("Meeting_date", "{0:dd/MM/yyyy}") %>
    </ItemTemplate>
    <ItemStyle HorizontalAlign="Left" />
</asp:TemplateField>
