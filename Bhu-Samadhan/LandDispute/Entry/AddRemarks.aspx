<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AddRemarks.aspx.cs" Inherits="Police_Station_add" %>
                ...
                <div class="row">
                    <div class="col-md-12">
                             ...
                             <asp:GridView ID="GridView1"  runat="server"
                                ...
                                CssClass="CSSTableGeneratorGrid" AllowPaging="false"  Style="width: 100%;"
                                     ...
                                     <asp:TemplateField HeaderText="मंतव्य विवरण द्वारा" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="20%">
                                       ...
                                       <asp:TemplateField HeaderText="दस्तावेज देखें" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="30%">
                                        <ItemTemplate>
                                            ...
                                            <asp:ImageButton ID="Image1" Visible='<%# CheckNull(Eval("Remarks_file"))%>' path='<%#Eval("Remarks_file")%>' runat="server" ImageUrl="~/images/pdf.gif" Width="50px" Height="50px" Style="cursor: pointer" CommandArgument='<%# Container.DataItemIndex %>' CommandName="View"/>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" />
                                    </asp:TemplateField>
             ...
             <div class="card-body">                
                  <div class="row" style="padding-top: 7px">
                    ...
                    <div class="col-md-2 text-left">
                        अपना मंतव्य अंकित करें 
                    </div>
                    <div class="col-md-8 text-left">
                        <asp:TextBox runat="server" MaxLength="1500" CssClass="form-control" TextMode="MultiLine" Height="300px" ID="txtabhiyukt_thaanprabhaaree"
                            ></asp:TextBox>
            ...
            <div id="tddetails" runat="server" visible="true">
                <div class="row" style="padding-bottom: 0.5%; padding-left: 0.5%">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-3  ">
                        <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btn btn-primary" onClientClick="return SaveAnotherRemarks();"  OnClick="btnSave_Click" />
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-3  ">
