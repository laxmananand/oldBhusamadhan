<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AddMeetingApplication_co.aspx.cs" Inherits="LandDispute_Entry_AddMeetingApplication_co" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
  ...
  <script type="text/javascript">
      ...
      function getpdfdocument(urlpdf) {
          ...
          $.ajax({
              type: "POST",
              url: "AddMettingApplication.aspx/Getpdf",
              data: "{'url':'" + urlpdf + "'}",
