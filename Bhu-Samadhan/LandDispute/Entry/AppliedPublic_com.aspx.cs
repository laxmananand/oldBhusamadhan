...
public partial class LandDispute_Entry_AppliedPublic_com : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            if (Session["Role"].ToString() == "COOPT")
            {
    ...
    private void GV_GetThanaDeatilsPageWise(int pageIndex)
    {
        ...
        try
        {
            ...
            dt = clsData.GetDataTableWithProc("usp_GetSaveDataUnFinalizePublic_com", p);
            int totalRecord = 0;
            if (p[2].Value != null)
            {
    ...
    protected void lnkView_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.Redirect("Entry_Page_com.aspx?RegId=" + UrlRedirect);
