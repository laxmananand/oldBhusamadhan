<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master"  CodeFile="Finalize.aspx.cs" Inherits="LandDispute_Entry_Unfinalize" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="container-fluid">
          <h4 class="text-black text-center"><b>Finalize Application</b></h4>
        ...
        <div class="card">
                                             ...
                                             <div class="card-body">                                                             
                                                                 <div class="row">  
                                                                       ...
                                                                       <div class="col-md-3">
                               <label class="control-label" for="inputGroup"> बैठक का निष्कर्ष (Action) </label>
                     ...
                     <div class="col-md-12" style="font-weight: bolder;padding-top:5px;">
                         <asp:GridView runat="server" Width="100%" ID="grdMatterRegistration" AutoGenerateColumns="false" CssClass="table-responsive CSSTableGeneratorGrid fontsize" DataKeyNames="a_id" OnRowCommand="grdMatterRegistration_RowCommand"  >
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ApplicationNo" HeaderText="Application No" ItemStyle-Width="10%" />  
                             ...
                             <asp:TemplateField HeaderText="जिला <hr style='margin-bottom: 0px; margin-top: 0px;' /> अनुमंडल <hr style='margin-bottom: 0px; margin-top: 0px;' /> अंचल" ItemStyle-HorizontalAlign="Left"
                                ...
                                <ItemStyle HorizontalAlign="Left" />
                                         ...
                                         <asp:TemplateField HeaderText="Action" ItemStyle-Width="5%">
                                               <ItemTemplate>                                                 
                                                <asp:LinkButton ID="btnEdit" CssClass="btn btn-btn-success" runat="server" CommandArgument='<%#Eval("a_id")%>' CommandName="Modify" 
                                                 OnClick="lnkView_Click" OnClientClick="openwindow(this);">
