<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SearchAppForMeeting_Public.aspx.cs" Inherits="LandDispute_Entry_SearchAppForMeeting" %>
...
#divImage
    ...
    function getpdfdocument(urlpdf) {
        ...
        $.ajax({
            type: "POST",
            url: "SearchAppForMetting_Public.aspx/Getpdf",
            data: "{'url':'" + urlpdf + "'}",
