<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SearchAppForRemarksPublic.aspx.cs" Inherits="LandDispute_Entry_SearchAppForMetting" %>
...
<div class="col-md-2">
                                ...
                                <asp:DropDownList ID="ddlPageSize" runat="server" AutoPostBack="true" OnSelectedIndexChanged="PageSize_Changed" CssClass="form-control mb-2">
                                                         ...
                                                         <asp:ListItem Text="50" Value="50" />
                                                                    ...
                                                                    <div class="col-md-2">
                                                                        <br />
                                                                           <%-- <asp:Button ID="btnSearch" runat="server" Text="Search"  CssClass="btn btn-primary" OnClientClick="check();" onclick="btnSearch_Click"> </asp:Button>--%>  
                                                                        <asp:LinkButton class="btn btn-primary"  id="search" runat="server" OnClientClick="check();" onclick="btnSearch_Click">
                     ...
                     <div class="form-group text-center" style="padding-top: 8px; padding-bottom: 8px; border: none; ">
                                                     <div class="col-md-12">
                                                            <asp:Repeater ID="rptPager" runat="server" >
                                                                 <ItemTemplate>
                                                                        <asp:LinkButton ID="lnkPage" runat="server" Text = '<%#Eval("Text") %>' CommandArgument = '<%# Eval("Value") %>' Enabled = '<%# Eval("Enabled") %>' OnClick = "Page_Changed" style="padding:5px; border-radius:5px;color:black;text-decoration:none"></asp:LinkButton>
                                                                 </ItemTemplate>
                                                             </asp:Repeater>
                                                     </div>
                                            </div>
