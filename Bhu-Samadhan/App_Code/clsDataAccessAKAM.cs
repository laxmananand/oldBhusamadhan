...
/// </summary>
public class clsDataAccessAKAM
{
    ...
    {
        string Eurl = "http://rcdonline.bih.nic.in";
        return Eurl;
    }
    public string getPath1()
    {
        string Eurl = "http://epacs.bih.nic.in";
        return Eurl;
    }
