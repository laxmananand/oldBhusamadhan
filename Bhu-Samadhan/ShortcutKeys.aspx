<%@ Page Title="" Language="C#" MasterPageFile="~/LoginMaster.master" AutoEventWireup="true" CodeFile="ShortcutKeys.aspx.cs" Inherits="JantaDarbar_ShortcutKeys" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <div class="col-lg-12" style="padding-bottom:10px;background-color:White">
        ...
        <p style="font-weight:bold;color:black">
            Following table lists the information about different shortcut keys:</p>
        <style type="text/css">

        table.tableSReader { border-collapse:collapse;margin-left:130px;}
        ...
        <table class="tableSReader slink" width="750px">
            <tr style="background-color:#F4F6FB;">
                <td style="width:250px;text-align:center;font-weight:bold;color:black">
                    Shortcut Keys</td>
                <td style="width: 350px;text-align:center;font-weight:bold;color:black">
                    Web Page Name</td>                
            </tr>
            <tr>
                ...
                <td style="width: 350px;">
                    <a href="Login_Default.aspx" style="text-decoration:none;" >Home
                    </a>
                </td>                
            </tr>
            <tr>
                <td style="width:250px;color:black">
                    Alt+d</td>
                <td style="width: 350px;">
                   <a href="Login_Default.aspx" style="text-decoration:none;" >Official Login</a></td>                
            </tr>
