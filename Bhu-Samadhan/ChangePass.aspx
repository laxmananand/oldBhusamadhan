<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SamvidaChangePass.master"  CodeFile="ChangePass.aspx.cs" Inherits="CLG_ChangePass" %>
            ...
            <div class=" sb-nav-fixed ">                     
                <div class=" text-left"  style="width: 100%; margin-left: 0%;">
                    ...
                    <div class="row" style="margin:10px;">
                        <div class="col-md-3">
                                जिला*
                                <asp:DropDownList ID="ddlDistrict" runat="server" CssClass="form-control" Enabled="true" style="height:40px"
                                    AutoPostBack="True" OnSelectedIndexChanged="ddlDistrict_SelectedIndexChanged">
                                </asp:DropDownList>
                            </div>
                            <div class="col-md-3">
                                अनुमंडल*
                                <asp:DropDownList ID="ddlSubdivision" runat="server" CssClass="form-control" Enabled="true" style="height:40px"
                                    AutoPostBack="True" OnSelectedIndexChanged="ddlSubdivision_SelectedIndexChanged">
                                </asp:DropDownList>
                            </div>
                            <div class="col-md-3">
                                अंचल*
                                <asp:DropDownList ID="ddlBlock" runat="server" CssClass="form-control" Enabled="true" style="height:40px"
                                    AutoPostBack="True" OnSelectedIndexChanged="ddlBlock_SelectedIndexChanged">
                                </asp:DropDownList>
                            </div>
                           <div class="col-md-3" id="divThana" runat="server" >
                              थाना*
                                <asp:DropDownList ID="ddlPolice" runat="server" CssClass="form-control" Enabled="true" style="height:40px">
                                </asp:DropDownList>
                            </div>
                    ...
                    <div class="row" style="margin: 10px;">
                        ...
                        <div class=" col-lg-6 ">
                            <b> <asp:Label ID="labName" runat="server" Text="SHO/CO Name[*] :"></asp:Label></b>
                            <br />
                            ...
                            <asp:Panel ID="MpnlVerify" runat="server" Visible="false">
                                <div class="row">
                                    <div class=" col-lg-6 col-md-6">
                                        <asp:TextBox ID="MtxtOTP" runat="server" TextMode="SingleLine" MaxLength="6" placeholder="OTP" Width="100%" class=" form-control"></asp:TextBox>
                        ...
                        <div class=" col-lg-6 col-md-6">
                           <%-- <br />
                            ...
                            <asp:Panel ID="EpnlVerify" runat="server" Visible="false">
                                <div class="row">
                                    <div class=" col-lg-6 col-md-6">
                                        <asp:TextBox ID="EtxtOTP" runat="server" TextMode="SingleLine" MaxLength="6" placeholder="OTP" Width="100%" class=" form-control"></asp:TextBox>
